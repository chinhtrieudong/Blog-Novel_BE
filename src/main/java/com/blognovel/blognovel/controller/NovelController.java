...
public class NovelController {
    ...
    @PostMapping
    @Operation(summary = "Create a new novel (Admin only)", description = "Creates a new novel. Requires ADMIN role.")
    ...
    public ApiResponse<Void> likeNovel(@Parameter(description = "Novel ID") @PathVariable Long id, Principal principal) {
        Long userId = userService.getCurrentUser(principal.getName()).getId();
    ...
    public ApiResponse<Void> favoriteNovel(@Parameter(description = "Novel ID") @PathVariable Long id, Principal principal) {
        Long userId = userService.getCurrentUser(principal.getName()).getId();
